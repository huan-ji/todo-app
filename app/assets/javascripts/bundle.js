...
/***/ function(module, exports, __webpack_require__) {
	...
	var TaskList = __webpack_require__(162);
	
	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(TaskList, null), document.getElementById('root'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var TaskStore = __webpack_require__(1);
	var TaskListItem = __webpack_require__(164);
	var TaskForm = __webpack_require__(165);
	var DoneButton = __webpack_require__(166);
	  ...
	  render: function () {
	    ...
	    var taskTitles = this.state.store.map(function (task, i) {
	      return React.createElement(
	        'div',
	        { key: i },
	        React.createElement(DoneButton, { task: task }),
	        React.createElement(TaskListItem, { task: task })
	      );
	    });
	    // debugger;
	    return React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var TaskStore = __webpack_require__(1);
	var TaskDetailView = __webpack_require__(167);
	...
	var TodoListItem = React.createClass({
	  ...
	  render: function () {
	    ...
	    if (this.state.selected) {
	      selected = React.createElement(TaskDetailView, { task: this.props.task });
	    }
	    return React.createElement(
	      'div',
	      null,
	  ...
	  render: function () {
	    ...
	    var displaySteps = steps.map(function (step, i) {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          'button',
	          { onClick: self.handleStepDoneClick.bind(self, step.id) },
	          text
	        )
	      );
	    });
	    ...
	    return React.createElement(
	      ...
	      displaySteps,
	      React.createElement(StepForm, { taskId: this.props.task.id })
	    );
	  }
